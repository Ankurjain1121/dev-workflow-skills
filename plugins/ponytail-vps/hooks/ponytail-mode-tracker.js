...
function finish() {
  ...
  try {
    ...
    if (/^[/@$]ponytail/.test(prompt)) {
      ...
      if (cmd === '/ponytail-review' || cmd === '/ponytail:ponytail-review' || cmd === '/ponytail-vps:ponytail-review') {
        mode = 'review';
      } else if (cmd === '/ponytail' || cmd === '/ponytail:ponytail' || cmd === '/ponytail-vps:ponytail') {
