...
function getFallbackInstructions(mode) {
  return 'PONYTAIL MODE ACTIVE — level: ' + mode + '\n\n' +
    ...
    '2. Does it already exist anywhere on this VPS? Run ${CLAUDE_PLUGIN_ROOT}/scripts/vps-find.sh <keywords>; copy and adapt what is already here, do not re-write it.\n' +
